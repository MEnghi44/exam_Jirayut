...
//constructor
const Restaurant = function (restaurants){  //ใช้ arrow function ไม่สามารถกำหนด คอนสเต็คเตอร์ได้
    //Attributes
    this.id = restaurants.id;
    this.name = restaurants.name;
    this.type = restaurants.type;
    this.imageurl = restaurants.imageurl;
};
